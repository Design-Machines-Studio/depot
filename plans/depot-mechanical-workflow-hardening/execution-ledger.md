...
| 08-cross-plugin-release-integration | Integration | codex / complete | 449 focused + 89 CLI/runtime/release tests passed | passed (2 iterations) | merged (`3d316c4`) | Docker 0/0; worktree and merged branch removed |
