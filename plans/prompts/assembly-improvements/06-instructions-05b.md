...
Task and non-goals:
The audit found no AGENTS.md and a useful CLAUDE.md. Add a thin portable instruction entrypoint. Inspect local instruction/skill/hook surfaces and correct only conflicts with the accepted shared policy.
