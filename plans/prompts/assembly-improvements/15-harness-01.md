...
The Foreman instruction cleanup is not a runtime prerequisite. Use current routing guidance and current repository contracts; the real prerequisite is an available compatible adapter and authority over the files being changed. Recheck Floor PR #6 and all Foreman worktrees; keep changes in Foreman and hand off Floor-specific UI work.
