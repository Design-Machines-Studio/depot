---
name: recipe-convert
description: Codex skill alias for /recipe-convert. Convert a recipe to a healthy, Bali-friendly version and export as a .melarecipe file
argument-hint: "[recipe name from Mela, URL, or paste recipe text]"
---

# Codex Command Alias: /recipe-convert

<!-- Generated by tools/generate-codex-command-skills.py; edit the source command instead. -->

- This generated skill exposes the Claude slash command `/recipe-convert` to Codex.
