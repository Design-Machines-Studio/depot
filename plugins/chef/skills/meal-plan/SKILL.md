---
name: meal-plan
description: Codex skill alias for /meal-plan. Generate a meal plan following Eve Persak's timing framework
argument-hint: "[number of days, any constraints or preferences]"
---

# Codex Command Alias: /meal-plan

<!-- Generated by tools/generate-codex-command-skills.py; edit the source command instead. -->

- This generated skill exposes the Claude slash command `/meal-plan` to Codex.
