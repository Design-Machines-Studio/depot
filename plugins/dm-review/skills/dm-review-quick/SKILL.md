...
description: Codex skill alias for /dm-review-quick. Quick code review with 5 core criteria (6 logical lanes when OpenRouter adds its security lens), plus ui-standards-reviewer for UI changes
