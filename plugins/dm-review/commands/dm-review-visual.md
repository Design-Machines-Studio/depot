...
2. Execute with the provided argument:
   - No argument: use the established project domain and canonical checkout
     with the feature branch selected. Follow shared repository discovery and
     documented rebuild/readiness; no new harness or environment reconfiguration.
     An attached preview is browser transport, not target authority.
