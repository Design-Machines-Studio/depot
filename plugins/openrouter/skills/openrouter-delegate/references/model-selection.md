...
| `z-ai/glm-5.3-flash` | $0.075 / $0.25 | 1,310,720 | Formerly Ox Alpha; first screen rate-limited and not routed |
...
catalogued for the local suite but not routed. After an explicit operator spend
override, its first `pipeline-legacy-translation` screen was retained as an
incomplete HTTP 429 `rate_limited` failure with no output or billed cost. The
remaining three cases were skipped after provider refusal. MiMo-V2.5, Hy3,
