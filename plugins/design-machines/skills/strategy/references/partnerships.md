# Partnerships & Ecosystem Reference

## The Solidarity Principle

The co-op sector doesn't operate on zero-sum competition. We're all working to make the sector bigger. Partners doing great work make potential clients stronger. This solidarity is a competitive advantage against capitalist software. Their incentives fight against coordination. Ours don't.
...
Current partner details (names, organizations, meeting schedules, relationship status) are stored in ai-memory. Search for partner names or "Design Machines" relationships to get the latest.
...
After conference talks on AI and labor, multiple people have expressed interest in organizing. Three engagement levels: Voice (recommended start), Connector, Builder.
