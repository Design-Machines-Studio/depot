# Pitch: Co-op developers, federations, incubators

The primary audience. USFWC, CWCF, DAWI (Democracy at Work Institute), Cooperation Works!, Cooperatives Europe. They recommend Assembly to dozens of member co-ops each. The federation is the channel; the co-ops are the members.
...
- **Sectoral density.** Tools that strengthen co-op-to-co-op trade and federation infrastructure beat tools that just serve one org.
- **Survival rates as propaganda ammunition.** They live with the exhausting stereotype that they manage decline. The data lets them lead with strength.
...
- "Your TA work compresses from five months to five days."
- "The federation is the channel; the co-ops are the members."
- "Assembly is what your consulting engagement leaves behind."
- "Bylaws become operational, not aspirational."
- "Built for the movement, in the movement."
- "You're already managing the business form that outlasts the others. Assembly compounds that lead."
...
The developer / federation pitch and the co-op pitch are different products from a sales-motion view, even if the underlying tool is the same. The developer cares about pipeline economics and curriculum embedding. The co-op member cares about Tuesday-morning governance. Two decks. Two landing pages. Two openers. Same Assembly underneath.
