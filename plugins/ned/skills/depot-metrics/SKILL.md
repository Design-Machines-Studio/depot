---
name: depot-metrics
description: Codex skill alias for /depot-metrics. Track and report plugin usage metrics via ai-memory
argument-hint: "[record <skill> <outcome> | report | sync]"
---

# Codex Command Alias: /depot-metrics

<!-- Generated by tools/generate-codex-command-skills.py; edit the source command instead. -->

- This generated skill exposes the Claude slash command `/depot-metrics` to Codex.
