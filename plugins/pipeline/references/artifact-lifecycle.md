...
| `pipeline-shadow-observation.json` | 2 | Observation-only RunSpec/event snapshot generated by `observe-pipeline` |
...
| `.claude/ux-review/workflow-kernel/review-shadow-observation.json` | 2 | Observation-only review RunSpec/event snapshot |
