---
name: pipeline-fix
description: Codex skill alias for /pipeline-fix. Fix-pass pipeline -- consumes numbered findings, reuses the current branch, enforces before/after baselines
argument-hint: "[path or URL to findings document]"
---

# Codex Command Alias: /pipeline-fix

<!-- Generated by tools/generate-codex-command-skills.py; edit the source command instead. -->

- This generated skill exposes the Claude slash command `/pipeline-fix` to Codex.
