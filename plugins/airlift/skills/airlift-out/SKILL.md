---
name: airlift-out
description: Codex skill alias for /airlift-out. Create or refresh a portable .airlift session handoff bundle.
argument-hint: "[--commit | --no-commit] [note]"
---

# Codex Command Alias: /airlift-out

<!-- Generated by tools/generate-codex-command-skills.py; edit the source command instead. -->

- This generated skill exposes the Claude slash command `/airlift-out` to Codex.
