...
- **Punchy fragments**: "Everywhere." / "The machines are here." / "We design like machines."
- **Medium declarative sentences**: Clean subject-verb-object with no decoration.
- **Longer analytical passages**: Complex ideas that unspool over a full paragraph, building toward a conclusion.
...
- "Mainlining that black tar straight into the jugular of our organizations"
- "Mushy bags of irrationality and emotion"
- "A/B test up the rectum"
- "Squeezed expression and emotion right out of the design process"
- "Whip crunchy words into tart sentences like a classic rhubarb crisp"

The metaphors are:
- **Embodied**: They reference bodies, physical sensation, visceral experience
- **Register-mixing**: High concept married to low culture imagery
...
### Trademark phrases and patterns

- "No bullshit" / "Performance and flexibility without the bullshit"
...
- "delve" / "delving into"
- "tapestry" (of ideas, culture, etc.)
- "landscape" (as metaphor for a field or domain)
- "navigate" (challenges, complexities)
- "leverage" (as a verb)
- "foster" (growth, community, connections)
- "holistic"
- "robust"
- "multifaceted"
...
- "double down"
- "move the needle"
- "align" / "alignment" (outside of literal design context)
- "stakeholder" (Travis uses "worker," "owner," "team member" — specific roles)
...
- **Uniform sentence length**: AI tends to write sentences that are all roughly the same length. Travis varies wildly — fragments to complex multi-clause sentences.
- **Lack of genuine surprise**: AI writing is relentlessly smooth. Travis's writing has jolts, pivots, and moments where the register suddenly shifts. Embrace the rough edges.
- **Over-hedging**: "Perhaps," "it could be argued," "some might say." Travis takes positions. He says "I believe" or just states it as fact. Hedging is for cowards and academics (his words, approximately).
- **Mechanical transitions**: "Furthermore," "Moreover," "Additionally," "In addition." Travis transitions with content, not conjunctions. The next paragraph picks up where the last one left off, or it pivots with a short sharp sentence.

### Emotional tells

- **Performative empathy**: "I understand how frustrating this can be." Travis shows empathy through specificity and shared experience, not by announcing that he's empathizing.
- **Excessive positivity**: "This is an exciting opportunity!" Travis is enthusiastic about things he cares about, but the enthusiasm is earned and specific, not generic cheerleading.
- **Faux humility**: "I'm just one person, but..." Travis is confident. He states his views clearly. When he's uncertain, he says so directly.
