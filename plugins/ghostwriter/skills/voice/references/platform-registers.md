# Platform-Specific Voice Registers

Detailed voice and tone guidance for each social platform. The social-media skill (`skills/social-media/SKILL.md`) owns format constraints, character limits, posting frequency, algorithmic mechanics, and hashtag strategy. This file covers only how Travis **sounds** on each platform.
