...
This skill encodes what works on each platform as of early 2026. It covers algorithm mechanics, format strategy, posting cadence, and cross-posting rules. **Always pair with the voice skill** — specifically the "Platform-Specific Registers" section in `skills/voice/SKILL.md`, which defines how Travis sounds on each platform. This skill handles platform mechanics; voice handles tone and register.
...
### Timezone Reality Check (Bali → Audience)
...
|----------|-------------|-------------------|
| LinkedIn | Tue-Thu 10-11 AM ET / 3-4 PM GMT | **Tue-Thu 10-11 PM WITA** |
| Instagram | Tue-Thu 11AM-6PM audience local | **Tue-Thu 11 PM - 6 AM WITA** (evening/overnight) |
...
|----------|-----------|-------------|-----------|------------|----------|
| LinkedIn | 3,000 | PDF carousels, text posts 1300-1600 chars | 2-5/week, 12-24hr gap | Tue-Thu 10-11 AM local | 3-5, niche > broad |
| Instagram | 2,200 caption | Carousels (20 slides), Reels <30s | 3-5 feed + 2-4 Reels/week | Tue-Thu, 11AM-6PM | 3-5 max (capped Dec 2025) |
...
### Platform Priority (Where to Invest Limited Energy)

1. **LinkedIn** — largest immediate reach for professional thought leadership. DM's substantive content is exactly what the algorithm now rewards. Start here.
2. **Bluesky** — high-opportunity early-adopter play. Smaller audience but 4.2% engagement rate, zero paid competition, community of journalists/academics/technologists who amplify ideas into mainstream discourse. Link-friendly. Growing fast.
3. **Instagram** — visual discovery through Reels, authority through carousels. Demands consistent visual production which is higher effort. Worth it for the propaganda poster angle but don't force it if bandwidth is tight.
4. **Mastodon** — patient community building. Deeply engaged niche audience of exactly the amplifier types (academics, journalists, technologists) who spread ideas. Rewards genuine participation over time. Low effort per post, high consistency required.
...
- LinkedIn: 10-slide PDF carousel with 1,300-char text post
- Instagram: 5-slide visual carousel with keyword-rich caption
- Bluesky: 4-post threaded analysis with custom-feed hashtags
- Mastodon: CW-tagged text post with discussion prompt and relevant hashtags
...
## DM Content Themes by Platform

| Platform | Primary Content | Format |
|----------|----------------|--------|
| LinkedIn | Cornerstone ideas — co-op movement, workplace democracy, labor analysis, what's wrong with corporate ownership, alternatives that work | PDF carousels, 1,300-1,600 char text |
| Instagram | Propaganda posters — visual-first quotes, satirical infographics, parody corporate announcements, sharp one-liners | Carousel graphics, short Reels |
...
1. **Determine platform(s)** — which platform is this for? If multiple, draft separately for each.
2. **Load voice skill** — match the platform register from "Platform-Specific Registers" in `skills/voice/SKILL.md`. Voice owns how Travis sounds; this skill owns format and mechanics.
3. **Check format** — what format performs best for this content type on this platform?
4. **Respect limits** — character counts, hashtag caps, image specs.
