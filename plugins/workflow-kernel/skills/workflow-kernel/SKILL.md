...
or above the declared `>=0.6.1` capability floor. The complete consumer-facing
...
Initialize every run in shadow mode by default. Version 0.6.1 permits a
...
0.6.1 surface includes state/replay and inspection commands, repository
