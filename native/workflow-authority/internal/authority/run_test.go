...
func fixture(t *testing.T) (protocol.Request, protocol.Challenge, Config, *fakeClock) {
	...
	authority := protocol.Authority{DaemonBuildSHA256: d, ScannerBuildSHA256: d, PolicySHA256: d, Nonce: "caller-nonce-01", Sequence: 7, BootID: "boot-01", SessionID: "session-01", ConnectionNonceSHA256: d, IssuedAt: now.Format(time.RFC3339), ExpiresAt: now.Add(2 * time.Minute).Format(time.RFC3339), PriorChainDigest: d, AllocationHelloSHA256: d, DispatchProposalSHA256: d}
