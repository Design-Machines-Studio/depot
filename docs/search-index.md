...
**31 skills** across 15 plugins | **31 agents** (17 review, 14 workflow) | **27 commands**
...
| pipeline | research | research, context-gathering, ai-memory, rag, domain-knowledge | ai-memory | "research for feature", "gather context for planning", "what do we know about", "research before building" |
...
| dm-review | /dm-review-quick | [optional: PR number, branch name, or file path] | Quick code review with 5 core agents only |
...
| pipeline | /pipeline-run | [path to manifest or prompts directory] | Execute generated prompts in worktrees with review-fix loops |
