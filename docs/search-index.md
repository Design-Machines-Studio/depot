...
**39 skills** across 19 plugins | **42 agents** (23 review, 19 workflow) | **36 commands**
...
| deepseek | deepseek-delegate | deepseek, delegation, code-review, diff-analysis, subagent, cost-optimization | -- | "use deepseek", "ask deepseek", "delegate to deepseek", "deepseek review", "cheaper code review", ... |
...
| deepseek | deepseek-bulk-analyst | review | diff, review, large-context, deepseek |
| deepseek | deepseek-code-analyst | workflow | code-analysis, patterns, refactoring, architecture, deepseek |
...
| gemini | gemini-diff-analyst | review | diff, review, large-context, gemini |
| gemini | gemini-search-grounded | workflow | search, citations, research, web, gemini |
| gemini | gemini-code-executor | workflow | code-execution, verification, python, sandbox, gemini |
...
| deepseek | /deepseek | <prompt> [--model v4-pro|v4-flash] | Direct DeepSeek V4 invocation with model selection |
...
| gemini | /gemini | <prompt> [--model flash|pro|flash-lite] | Direct Gemini invocation with model selection |
| gemini | /gemini-search | <query> | Search-grounded query returning cited results |
