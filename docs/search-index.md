...
**43 skills** across 18 plugins | **38 agents** (22 review, 16 workflow) | **35 commands**
...
| project-manager | assembly-coordinator | assembly, coordination, github, cross-repository, scope-guard, fixture-planning | -- | "fresh Assembly planning session", "Assembly Coordination Project", "next Assembly development chunk", "completed Assembly PR follow-up", "Fixture dependency planning", ... |
