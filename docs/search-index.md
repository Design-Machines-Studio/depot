...
**40 skills** across 19 plugins | **40 agents** (23 review, 17 workflow) | **34 commands**
...
| workflow-kernel | workflow-kernel | workflow, state-machine, event-ledger, recovery | -- | "workflow kernel", "replay workflow events", "validate run state", "materialize workflow state" |
