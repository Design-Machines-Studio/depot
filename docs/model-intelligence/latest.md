...
The BaseTen and Modal GLM rows and the BaseTen DeepSeek row are retained
pre-fix evidence and are not comparable. The corrected GLM set is the two
Parasail attempts plus the Reka attempt; all three scored 100/100, with medians
of 5 seconds, 160 prompt tokens, 155 completion tokens, 111 reasoning tokens,
and $0.0000975 provider-billed cost. The comparable DeepSeek set is the two
Fireworks attempts plus the Parasail attempt; all three scored 100/100, with
medians of 6 seconds, 163 prompt tokens, 258 completion tokens, 195 reasoning
tokens, and $0.00123684 provider-billed cost. The generic report groups by
provider and does not yet encode harness-version comparability or lift nested
reasoning-token details, so those medians remain interpreted receipt evidence.
...
| z-ai/glm-5.3-flash | Parasail | pipeline-legacy-translation | 2/2 | 100.0 | 4.5s | $0.0001 |
| z-ai/glm-5.3-flash | Reka | pipeline-legacy-translation | 1/1 | 100.0 | 7.0s | $0.0001 |
