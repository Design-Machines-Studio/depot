...
assembly_floor = None if pipeline is None else pipeline.get("optionalPluginDependencies", {}).get("assembly")
if assembly_floor != ">=3.9.0":
    errors.append("pipeline must optionally require assembly >=3.9.0")
