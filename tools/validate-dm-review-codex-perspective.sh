...
require_text "$REPO_ROOT/plugins/dm-review/.claude-plugin/plugin.json" '"version": "1.80.1"' "canonical dm-review version is 1.80.1"
require_text "$REPO_ROOT/plugins/dm-review/.codex-plugin/plugin.json" '"version": "1.80.1"' "generated dm-review version is 1.80.1"
