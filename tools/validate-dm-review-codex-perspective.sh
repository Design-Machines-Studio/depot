...
require_text "$REPO_ROOT/plugins/dm-review/.claude-plugin/plugin.json" '"version": "1.83.1"' "canonical dm-review version is 1.83.1"
require_text "$REPO_ROOT/plugins/dm-review/.codex-plugin/plugin.json" '"version": "1.83.1"' "generated dm-review version is 1.83.1"
require_text "$REPO_ROOT/plugins/pipeline/.claude-plugin/plugin.json" '"version": "1.69.1"' "canonical Pipeline version is 1.69.1"
require_text "$REPO_ROOT/plugins/pipeline/.codex-plugin/plugin.json" '"dm-review": ">=1.83.0"' "generated Pipeline dependency floor is current"
