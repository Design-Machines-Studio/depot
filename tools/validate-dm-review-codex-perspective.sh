...
require_text "$REPO_ROOT/plugins/dm-review/.claude-plugin/plugin.json" '"version": "1.83.2"' "canonical dm-review version is 1.83.2"
require_text "$REPO_ROOT/plugins/dm-review/.codex-plugin/plugin.json" '"version": "1.83.2"' "generated dm-review version is 1.83.2"
require_text "$REPO_ROOT/plugins/pipeline/.claude-plugin/plugin.json" '"version": "1.69.2"' "canonical Pipeline version is 1.69.2"
