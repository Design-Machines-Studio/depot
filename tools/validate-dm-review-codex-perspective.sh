...
require_text "$REPO_ROOT/plugins/dm-review/.claude-plugin/plugin.json" '"version": "1.65.0"' "canonical dm-review version is 1.65.0"
require_text "$REPO_ROOT/plugins/dm-review/.codex-plugin/plugin.json" '"version": "1.65.0"' "generated dm-review version is 1.65.0"
require_text "$REPO_ROOT/plugins/pipeline/.claude-plugin/plugin.json" '"version": "1.55.0"' "canonical Pipeline version is 1.55.0"
