...
require_text "$REPO_ROOT/plugins/dm-review/.claude-plugin/plugin.json" '"version": "1.81.0"' "canonical dm-review version is 1.81.0"
require_text "$REPO_ROOT/plugins/dm-review/.codex-plugin/plugin.json" '"version": "1.81.0"' "generated dm-review version is 1.81.0"
require_text "$REPO_ROOT/plugins/pipeline/.claude-plugin/plugin.json" '"version": "1.68.0"' "canonical Pipeline version is 1.68.0"
require_text "$REPO_ROOT/plugins/pipeline/.codex-plugin/plugin.json" '"dm-review": ">=1.81.0"' "generated Pipeline dependency floor is current"
