...
require_text "$REPO_ROOT/plugins/dm-review/.claude-plugin/plugin.json" '"version": "1.80.2"' "canonical dm-review version is 1.80.2"
require_text "$REPO_ROOT/plugins/dm-review/.codex-plugin/plugin.json" '"version": "1.80.2"' "generated dm-review version is 1.80.2"
