...
require_text "$reviewer_prompt_template" 'No recaps, praise, approval' "reviewer prompts reject narrative padding"
require_text "$reviewer_prompt_template" 'suppress a supported finding for brevity' "reviewer prompts preserve supported findings"
...
require_text "$REPO_ROOT/plugins/dm-review/.claude-plugin/plugin.json" '"version": "1.67.0"' "canonical dm-review version is 1.67.0"
require_text "$REPO_ROOT/plugins/dm-review/.codex-plugin/plugin.json" '"version": "1.67.0"' "generated dm-review version is 1.67.0"
