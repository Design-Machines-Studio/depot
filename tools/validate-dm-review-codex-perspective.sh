...
require_text "$REPO_ROOT/plugins/dm-review/.claude-plugin/plugin.json" '"version": "1.69.0"' "canonical dm-review version is 1.69.0"
require_text "$REPO_ROOT/plugins/dm-review/.codex-plugin/plugin.json" '"version": "1.69.0"' "generated dm-review version is 1.69.0"
