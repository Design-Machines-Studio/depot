...
require_text "$plan_adversary" 'First audit the independent rendered-surface declaration for every chunk' "plan adversary audits applicability independently"
require_text "$plan_adversary" 'A syntactic trigger with an incomplete rationale is a **BLOCKER**' "plan adversary rejects unsupported N/A"
