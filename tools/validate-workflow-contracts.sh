...
require_text "$REPO_ROOT/plugins/dm-review/.claude-plugin/plugin.json" '"workflow-kernel": ">=0.18.3"' "dm-review requires origin-neutral family observation support"
require_text "$REPO_ROOT/plugins/pipeline/.claude-plugin/plugin.json" '"dm-review": ">=1.78.0"' "pipeline requires the origin-neutral dm-review release"
