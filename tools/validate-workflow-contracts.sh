...
require_text "$orchestrator" "Raw passing stdout/stderr and repeated copies of the receipt must not enter" "passing verification output stays out of later model prompts"
...
require_text "$promptcraft" "A passing or reused result appears once as selected check IDs" "promptcraft bounds passing verification evidence"
