...
require_text "$REPO_ROOT/plugins/dm-review/.claude-plugin/plugin.json" '"workflow-kernel": ">=0.20.0"' "dm-review requires strict repository-scoped registry validation"
